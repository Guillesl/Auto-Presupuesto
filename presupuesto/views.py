...
def results(request):
    ...
    try:
        ...
        error_message = "No hay referencias de similares a este proyecto, asegurate de que tus valores son coherentes (ojo al tipo de integración)"
        return render(request, 'presupuesto/index.html', {"form": ProjectForm, "error_message":error_message,})
