...
class ProjectForm(forms.ModelForm):
    class Meta:
        model = Project
        fields = "__all__"
        exclude = ['name', 'cost', 'solar_field_cost', 'bop_cost', 'construction_cost', 'transport_cost', 'storage_cost']

    def __init__(self, *args, **kwargs):
        super(ProjectForm, self).__init__(*args, **kwargs)
        self.fields['num_colect'].initial = 50
        ...
        self.fields['surface'].initial = "ground_paved"
        self.fields['vehicule'].initial = "ship"
